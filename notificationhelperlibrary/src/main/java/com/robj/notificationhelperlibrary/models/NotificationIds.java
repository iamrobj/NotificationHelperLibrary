...
public class NotificationIds {
    ...
    public NotificationIds(final Context context) {
        ICON = context.getResources().getIdentifier("android:id/icon", null, null);
        TITLE = context.getResources().getIdentifier("android:id/title", null, null);
        BIG_TEXT = context.getResources().getIdentifier("android:id/big_text", null, null);
        TEXT = context.getResources().getIdentifier("android:id/text", null, null);
        BIG_PIC = context.getResources().getIdentifier("android:id/big_picture", null, null);
        EMAIL_0 = context.getResources().getIdentifier("android:id/inbox_text0", null, null);
        EMAIL_1 = context.getResources().getIdentifier("android:id/inbox_text1", null, null);
        EMAIL_2 = context.getResources().getIdentifier("android:id/inbox_text2", null, null);
        EMAIL_3 = context.getResources().getIdentifier("android:id/inbox_text3", null, null);
        EMAIL_4 = context.getResources().getIdentifier("android:id/inbox_text4", null, null);
        EMAIL_5 = context.getResources().getIdentifier("android:id/inbox_text5", null, null);
        EMAIL_6 = context.getResources().getIdentifier("android:id/inbox_text6", null, null);
        INBOX_MORE = context.getResources().getIdentifier("android:id/inbox_more", null, null);
        new AsyncTask() {
            @Override
...
//                .setSmallIcon(R.drawable.ic_launcher) //TODO: Is this required
                .setContentTitle("1")
                .setContentText("2")
                .setContentInfo("3")
                .setSubText("4");
